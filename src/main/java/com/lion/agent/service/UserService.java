...
public interface UserService {
     ...
     *
     * @throws com.lion.agent.common.BusinessException 用户名已存在
     */
     ...
     * 编辑用户(用户名唯一校验, 排除自身)
     *
     * @throws com.lion.agent.common.BusinessException 用户名已存在 / 用户不存在
     */
     ...
     * 删除用户
     *
     * @throws com.lion.agent.common.BusinessException 用户不存在
     */
    void delete(Long id);
